...
def getWeather():
    ...
    #weather
    api="https://api.openweathermap.org/data/2.8/onecall?lat="+str(location.latitude)+"&lon="+str(location.longitude)+"&units=metric&exclude=hourly&appid=4b1ad6eb1d52c3899d03f0e988f626e9"
    ...
    tempnight1=json_data['daily'][0]['temp']['day']
    ...
    tempnight2=json_data['daily'][1]['temp']['day']
    ...
    tempnight3=json_data['daily'][2]['temp']['day']
    ...
    tempnight4=json_data['daily'][3]['temp']['day']
    ...
    tempnight5=json_data['daily'][4]['temp']['day']
    ...
    tempnight6=json_data['daily'][5]['temp']['day']
    ...
    tempnight7=json_data['daily'][6]['temp']['day']
